...
function displayDarkTheme() {
    ...
    myBody.style.setProperty('--background-color', '#242424');
    myBody.style.setProperty('--input-border-color', '#FFF');
    myBody.style.setProperty('--color', '#FFF');
    myBody.style.setProperty('--shadow-color', '0px 4px 8px rgba(255,255,255,0.15)');
    myBody.style.setProperty('--highlight-background', '#454545');
    myBody.style.setProperty('--highlight-color', 'rgba(255,255,255,0.7');
    myBody.style.setProperty('--highlight-description', '#FFF');
}
...
function displayLightTheme() {
    ...
    myBody.style.setProperty('--background-color', '#FFF')
    myBody.style.setProperty('--input-border-color', '#979797');
    myBody.style.setProperty('--color', '#000');
    myBody.style.setProperty('--highlight-background', '#fff');
    myBody.style.setProperty('--highlight-color', 'rgba(0, 0, 0, 0.7)');
    myBody.style.setProperty('--highlight-description', '#000');
}
...
function loadHighlightMovie() {
    ...
    basePromise.then(function (response) {
        ...
        bodyPromise.then(function (body) {
            ...
            highlightGenre.textContent = body.genres.map(function (genre) {
                return genre.name;
            }).join(', ');
